 ...
 */
final class Version20210812063408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande_detail ADD CONSTRAINT FK_2C52844616A2B381 FOREIGN KEY (book_id) REFERENCES books (id)');
    }
